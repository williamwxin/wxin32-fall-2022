...
log_cols = [2,3,4,5,6,9,10]
for i in log_cols:
    train_x[:,i] = np.log(train_x[:,i]+1)
    test_x[:, i] = np.log(test_x[:, i] + 1)
...
#     km_res[i,0] = metrics.silhouette_score(train_x, pred_c)
#     km_res[i,1] = metrics.adjusted_rand_score(pred_c, train_y)
#     km_res[i,2] = metrics.adjusted_mutual_info_score(pred_c, train_y)
#
#     model = GaussianMixture(n_components=k)
#     model.fit(train_x)
#     pred_c = model.predict(train_x)
#     em_res[i, 0] = metrics.silhouette_score(train_x, pred_c)
#     em_res[i, 1] = metrics.adjusted_rand_score(pred_c, train_y)
#     em_res[i, 2] = metrics.adjusted_mutual_info_score(pred_c, train_y)
#
#     print(k)
#
# sns.set()
...
# plt.title('Wine: K-Means')
# plt.xlabel('K')
# plt.ylabel('Metric Value')
# sns.lineplot(y=km_res[:, 0], x=k_range, label='Silhuoutte')
# sns.lineplot(y=km_res[:, 1], x=k_range, label='Adj RAND')
# sns.lineplot(y=km_res[:, 2], x=k_range, label='Adj Mutual Info')
# plt.savefig('wine k means')
#
# sns.set()
# fig, ax = plt.subplots(figsize=(4, 2))
# plt.subplots_adjust(bottom=.26)
...
# plt.xlabel('K')
# plt.ylabel('Metric Value')
# sns.lineplot(y=em_res[:, 0], x=k_range, label='Silhuoutte')
# sns.lineplot(y=em_res[:, 1], x=k_range, label='Adj RAND')
# sns.lineplot(y=em_res[:, 2], x=k_range, label='Adj Mutual Info')
# plt.savefig('wine em')
...
plt.subplots_adjust(bottom=.26)
plt.subplots_adjust(left=.16)
plt.title('Wine K-Means: Silhouette Score')
plt.xlabel('K')
plt.ylabel('Metric Value')
...
plt.savefig('wine p1 KM silhouette')

sns.set()
fig, ax = plt.subplots(figsize=(4, 2))
plt.subplots_adjust(bottom=.26)
plt.subplots_adjust(left=.16)
plt.title('Wine EM: Silhouette Score')
plt.xlabel('# Clusters')
plt.ylabel('Metric Value')
...
plt.savefig('wine p1 EM silhouette')
...
if False:
    ...
    plt.subplots_adjust(bottom=.26)
    plt.subplots_adjust(left=.16)
    plt.title('Wine K-Means: Distortion')
    plt.xlabel('K')
    plt.ylabel('Metric Value')
    ...
    plt.savefig('wine p1 KM distortion')
    ...
    plt.savefig('wine p1 EM distortion')


k_range = list(range(2,61,3))
...
plt.savefig('wine p1 vote')

accuracy_score(train_y,np.ones(len(train_y)))
...
pca_range = list(range(1,features+1))
...
ica_range = list(range(1,features+1))
ica_res = np.zeros((len(ica_range),2))
c = 11
for i, c in enumerate(ica_range):
    model = DC.FastICA(n_components=c)
    model.fit(train_x)
...
model = DC.FastICA(n_components=11, random_state=0)
model.fit(train_x)
...
plt.title('Wine: ICA')
sns.scatterplot(y=ica_kurt, x=ica_range)
plt.savefig('wine p1 ica kurt')
...
ax.legend(loc='center right')
plt.savefig('wine ica')

rp_range = list(range(1,features+1))
...
plt.title('Wine: Trunc SVD')
sns.lineplot(y=tsvd_res, x=tsvd_range, label='Rec Err', ax=ax)
ax.legend(loc='center right')
plt.savefig('wine tsvd')
...
for c,t_x in enumerate(train_xs):
    ...
    if True:  # p1 graphs
        ...
        plt.subplots_adjust(bottom=.26)
        plt.subplots_adjust(left=.16)
        plt.title('Wine: ' + model_names[c]+' Silhouette')
        plt.xlabel('K')
        plt.ylabel('Metric Value')
        sns.lineplot(y=km_res[:, 0], x=k_range, label='K-Means')
        sns.lineplot(y=em_res[:, 0], x=k_range, label='EM')
        plt.savefig('wine p2 ' + model_names[c]+' silhouette')

        sns.set()
        fig, ax = plt.subplots(figsize=(4, 2))
        plt.subplots_adjust(bottom=.26)
        plt.subplots_adjust(left=.16)
        plt.title('Wine: ' + model_names[c]+' Distortion')
        plt.xlabel('K')
        plt.ylabel('Metric Value')
        sns.lineplot(y=km_res[:, 1], x=k_range, label='K-Means')
        sns.lineplot(y=em_res[:, 1], x=k_range, label='EM')
        plt.savefig('wine p2 ' + model_names[c]+' distortion')
    ...
    if True:  # p1b graphs
        ...
        plt.subplots_adjust(bottom=.26)
        plt.subplots_adjust(left=.16)
        plt.title('Wine: ' + model_names[c]+' Adj Rand')
        plt.xlabel('K')
        plt.ylabel('Metric Value')
        sns.lineplot(y=km_res_2[:, 0], x=k_range, label='K-Means')
        sns.lineplot(y=em_res_2[:, 0], x=k_range, label='EM')
        plt.savefig('wine p2b ' + model_names[c]+' Rand')

        sns.set()
        fig, ax = plt.subplots(figsize=(4, 2))
        plt.subplots_adjust(bottom=.26)
        plt.subplots_adjust(left=.16)
        plt.title('Wine: ' + model_names[c]+' Adj Mutual Info')
        plt.xlabel('K')
        plt.ylabel('Metric Value')
        sns.lineplot(y=km_res_2[:, 1], x=k_range, label='K-Means')
        sns.lineplot(y=em_res_2[:, 1], x=k_range, label='EM')
        plt.savefig('wine p2b ' + model_names[c]+' MI')
...
if True:
    ...
    ax.set_ylabel('Accuracy')
    ax.set_xlabel('Iterations')
    plt.title('Wine 6: NN Validation')
    ...
    ax.set_ylabel('Accuracy')
    ax.set_xlabel('Iterations')
    plt.title('Wine 17: NN Validation')
    sns.lineplot(y=nn_base_res[:,2], x=range(200), label='Base (11 feat)', ax=ax)
    ...
    ax.set_ylabel('Accuracy')
    ax.set_xlabel('Iterations')
    plt.title('Wine 11: NN Validation')
    sns.lineplot(y=nn_base_res[:,2], x=range(200), label='Base (11 feat)', ax=ax)
    ...
    ax.set_ylabel('Accuracy')
    ax.set_xlabel('Iterations')
    plt.title('Wine 22: NN Validation')
    sns.lineplot(y=nn_base_res[:, 2], x=range(200), label='Base (11 feat)', ax=ax)
...
plt.title('Wine NN: Clock Time and Accuracy')
plt.xlabel('Dataset')
...
plt.title('Wine NN: KM Clustering Accuracy')
...
for xy in zip(k, nn_res[:17,1]):
    ...
    ax2.annotate('%s' % t, xy=xy, textcoords='data', fontsize=10, ha='center', verticalalignment='bottom', rotation=45)
ax.legend(loc = 'lower center')
plt.savefig('wine p4 KM')

fig, ax = plt.subplots(figsize=(4, 2))
plt.subplots_adjust(bottom=.27)
plt.subplots_adjust(left=.16)
plt.subplots_adjust(right=.98)
plt.title('Wine NN: EM Clustering Accuracy')
ax.set_xlabel('# Clusters (0 is NN with original data)')
ax.set_ylabel('Accuracy')
...
plt.subplots_adjust(left=.16)
plt.subplots_adjust(right=.98)
plt.title('Wine NN: KM Appended with Original Data')
ax.set_xlabel('# Clusters (0 is NN with original data)')
ax.set_ylabel('Accuracy')
...
ax.scatter(0,np.max(nn_base_res[:,2]), color='red')
ax.legend(loc = 'lower center')
plt.savefig('wine p4b KM')

fig, ax = plt.subplots(figsize=(4, 2))
plt.subplots_adjust(bottom=.27)
plt.subplots_adjust(left=.16)
plt.subplots_adjust(right=.98)
plt.title('Wine NN: EM Appended with Original Data')
ax.set_xlabel('# Clusters (0 is NN with original data)')
...
if True:
    ...
    ax.legend(loc='lower center', fontsize=8)
    plt.savefig('wine p4b KMEM train')
    ...
    ax.legend(loc='lower center', fontsize=8)
    plt.savefig('wine p4b KMEM test')
...
if True:
    ...
    ax.legend(loc='lower center', fontsize=8)
    plt.savefig('wine p4b KMEM train2')
    ...
    ax.legend(loc='lower center', fontsize=8)
    plt.savefig('wine p4b KMEM test2')
